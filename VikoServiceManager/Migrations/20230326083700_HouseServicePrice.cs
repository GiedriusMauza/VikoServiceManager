...
{
    /// <inheritdoc />
    public partial class HouseServicePrice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_House_ResidentGroup_ResidentGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseService", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_House_ResidentGroupId",
                table: "House",
                column: "ResidentGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_HouseService_HouseId",
                table: "HouseService",
                column: "HouseId");
